  ...
  return (
    <section className="mt-6 border-t-2 border-[#FFE8F0] pt-5">
      ...
      <form ref={formRef} action={formAction} className="flex flex-col gap-2">
        ...
        <select
          name="prefecture"
          className="border-2 border-[#FFD6E7] rounded-full px-4 py-2 text-sm text-[#5C3D5E] bg-[#FDFDF8] focus:outline-none focus:border-[#FF8FAB] focus:ring-2 focus:ring-[#FFD6E7] transition-colors"
        >
          <option value="">都道府県に紐づけない</option>
